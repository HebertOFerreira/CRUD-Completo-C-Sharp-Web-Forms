<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alterarUsuario_.aspx.cs" Inherits="CrudValidacaoNHibernate.WebApp.Administrador.alterarUsuario_" MasterPageFile="~/WebApp/Administrador/administradorMaster.Master" %>
    ...
    <form id="form" runat="server">
        ...
        <div style="float: left; margin-left: 450px; position: absolute; align-content: center; margin-top: 130px; font-size: 20px;">
            <div style="float: left; width: 200px; margin-left: 190px;">
                <asp:Label ID="Label1" runat="server" Text="Alterar Usuário"></asp:Label>
            </div>
        </div>
        ...
        <div style="float: left; margin-left: 300px; position: absolute; align-content: center; margin-top: 200px">
            ...
            <div style="float: left; margin-left: 20px;">
                <asp:TextBox ID="txtNomeUsu" runat="server" MaxLength="20" Height="18px" Width="200px" TextMode="SingleLine" ToolTip="Nome do Usuário"></asp:TextBox>
            </div>
        </div>
        ...
        <div style="float: left; margin-left: 300px; position: absolute; align-content: center; margin-top: 240px">
            ...
            <div style="float: left; margin-left: 20px;">
                <asp:TextBox ID="txtSenhaUsu" runat="server" MaxLength="12" Height="18px" Width="200px" TextMode="SingleLine" ToolTip="Senha do Usuário"></asp:TextBox>
            </div>
        </div>
