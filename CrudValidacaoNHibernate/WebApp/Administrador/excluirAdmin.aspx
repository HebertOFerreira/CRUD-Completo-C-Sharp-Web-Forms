<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="excluirAdmin.aspx.cs" Inherits="CrudValidacaoNHibernate.WebApp.Administrador.excluirAdmin" MasterPageFile="~/WebApp/Administrador/administradorMaster.Master" %>

<asp:Content ID="content" runat="server" ContentPlaceHolderID="cphConteudo">

    <script type="text/javascript">
        alert("Escolha um Administrador para ser excluído!");
    </script>
